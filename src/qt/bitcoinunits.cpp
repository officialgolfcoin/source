...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("GOLF");
    case mBTC: return QString("mGOLF");
    case uBTC: return QString::fromUtf8("μGOLF");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("GolfCoins"));
    case mBTC: return QString(QObject::tr("Milli-GolfCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-GolfCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
