GolfCoin-qt: Qt4 GUI for GolfCoin
===============================
...
Alternatively, install Qt Creator and open the `GolfCoin-qt.pro` file.

An executable named `GolfCoin-qt` will be built.
...
A warning for people using the *static binary* version of GolfCoin on a Linux/UNIX-ish system (tl;dr: **Berkely DB databases are not forward compatible**).

The static binary version of GolfCoin is linked against libdb5.3.
...
installed causes GolfCoin-qt to crash intermittently.  The issue has been reported as `launchpad bug 857790`_, but
isn't yet fixed.
